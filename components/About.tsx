            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-white/70 hover:bg-[#8b5cf6]/20 hover:border-[#8b5cf6]/50 hover:text-white transition-all duration-300"
